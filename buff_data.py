...
def shield(): return [('fill', (30, 25, 40)), ('rect', 7, 2, 10, 14, (100, 180, 255)), ('rect', 9, 4, 6, 10, (140, 220, 255)), ('rect', 5, 7, 14, 2, (100, 180, 255)), ('rect', 10, 6, 4, 6, (255, 255, 255))]
...
def drop(): return [('fill', (20, 25, 45)), ('circle', 12, 16, 3, (80, 150, 255)), ('rect', 11, 8, 2, 6, (140, 210, 255)), ('rect', 10, 10, 4, 2, (80, 150, 255)), ('circle', 12, 9, 2, (255, 255, 255))]
...
def bolt(): return [('fill', (40, 30, 15)), ('rect', 12, 3, 2, 6, (255, 220, 50)), ('rect', 9, 8, 4, 2, (255, 220, 50)), ('rect', 10, 10, 2, 4, (255, 220, 50)), ('rect', 10, 14, 4, 2, (195, 160, 0)), ('rect', 12, 16, 2, 6, (195, 160, 0)), ('circle', 13, 8, 2, (255, 255, 255))]
...
def sword(): return [('fill', (30, 25, 35)), ('rect', 11, 3, 2, 14, (200, 200, 220)), ('rect', 10, 2, 4, 1, (240, 240, 255)), ('rect', 10, 17, 4, 2, (100, 70, 40)), ('rect', 13, 14, 2, 3, (100, 70, 40)), ('rect', 7, 14, 2, 3, (100, 70, 40))]
...
def antenna(): return [('fill', (25, 25, 35)), ('rect', 11, 4, 2, 14, (180, 200, 240)), ('circle', 12, 4, 4, (210, 230, 255)), ('circle', 4, 8, 3, (210, 230, 255)), ('circle', 20, 8, 3, (210, 230, 255)), ('rect', 4, 8, 16, 1, (180, 200, 240))]
...
def aura(): return [('fill', (40, 35, 20)), ('circle', 12, 12, 9, (155, 120, 0)), ('circle', 12, 12, 5, (255, 220, 100)), ('circle', 12, 12, 2, (255, 255, 255)), ('rect', 7, 7, 10, 10, (255, 220, 100)), ('circle', 12, 12, 3, (255, 240, 120))]
...
def clover(): return [('fill', (20, 30, 25)), ('circle', 8, 8, 3, (50, 200, 80)), ('circle', 8, 8, 1, (110, 255, 140)), ('circle', 16, 8, 3, (50, 200, 80)), ('circle', 16, 16, 3, (50, 200, 80)), ('circle', 8, 16, 3, (50, 200, 80)), ('rect', 11, 14, 2, 8, (30, 180, 60))]
...
def vial(): return [('fill', (20, 30, 25)), ('rect', 10, 2, 4, 4, (40, 195, 60)), ('rect', 9, 6, 6, 14, (100, 255, 120)), ('rect', 10, 7, 4, 8, (130, 255, 150)), ('circle', 12, 12, 2, (40, 195, 60))]
...
# Composite icons
shield_fire = [('fill', (30, 25, 40)), ('rect', 7, 2, 10, 14, (255, 140, 50)), ('rect', 9, 4, 6, 10, (255, 180, 90)), ('rect', 5, 7, 14, 2, (255, 140, 50)), ('rect', 10, 6, 4, 6, (255, 255, 255)), ('rect', 9, 9, 6, 6, (255, 200, 50))]
...
soaked = [('fill', (20, 25, 45)), ('circle', 12, 16, 3, (100, 160, 240)), ('rect', 11, 8, 2, 6, (160, 220, 255)), ('rect', 10, 10, 4, 2, (100, 160, 240)), ('circle', 12, 9, 2, (255, 255, 255)), ('rect', 8, 10, 8, 4, (120, 200, 255))]
...
sword_x = [('fill', (30, 25, 35)), ('rect', 11, 3, 2, 14, (200, 200, 220)), ('rect', 10, 2, 4, 1, (240, 240, 255)), ('rect', 10, 17, 4, 2, (100, 70, 40)), ('rect', 13, 14, 2, 3, (100, 70, 40)), ('rect', 7, 14, 2, 3, (100, 70, 40)), ('rect', 7, 7, 10, 2, (200, 60, 60)), ('rect', 9, 7, 2, 10, (200, 60, 60))]
...
phys_immune = [('fill', (30, 25, 35)), ('rect', 11, 3, 2, 14, (255, 200, 100)), ('rect', 10, 2, 4, 1, (255, 240, 140)), ('rect', 10, 17, 4, 2, (100, 70, 40)), ('rect', 13, 14, 2, 3, (100, 70, 40)), ('rect', 7, 14, 2, 3, (100, 70, 40)), ('circle', 12, 12, 2, (255, 255, 180)), ('circle', 12, 12, 1, (255, 255, 255))]
...
def shore_icon():
    ...
    # 水平右(0°)→竖直下(270°)，step=15°
    for angle in [i*15*_m.pi/180 for i in range(0, 19)]:
        cos_a = _m.cos(angle)
        sin_a = _m.sin(angle)
    ...
    hy = neck_y - hr * _m.sin(neck_ang) - int(0.8 * hr * 2)
